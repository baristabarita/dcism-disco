...
const Venue: React.FC = () => {
  ...
  const handleScroll = () => {
    const overviewElement = document.getElementById("venue-section");
    if (overviewElement) {
  ...
  >
    Paradise Garden Events Pavilion is located at H. Abellana St, Mandaue City, Cebu, Philippines.
    <br/>
    Check them out by <a className="text-[#dadada]" href="https://www.google.com/maps/place/Paradise+Garden+Events+Pavilion/@10.3630047,123.9487533,15z/data=!4m6!3m5!1s0x33a99873eb866bdf:0xe54e22b8829efd98!8m2!3d10.3630047!4d123.9487533!16s%2Fg%2F1q62dzcns?entry=ttu&g_ep=EgoyMDI0MDgyMS4wIKXMDSoASAFQAw%3D%3D">clicking here</a>!
  </p>
</div>
    </section>
  );
